...
import type { LegalTermType } from "../components/LegalTerm";
...
const Home: NextPage = () => {
  ...
  const [legalTerm, setLegalTerm] = useState<LegalTermType>(
    "Employment Contract"
  );

  const [generatedTopics, setGeneratedTopics] = useState<string>("");

  const prompt = `I have a legal question regarding "${topic}" in the context of Philippines law. Specifically, I am seeking general legal information, advice and guidance related to ${lawArea} that may be relevant to my situation. For example, I am interested in knowing about ${legalTerm} and how it applies to my legal issue. I understand that you are not a licensed attorney and that your response is not legal advice, but I am seeking reliable resources or guidance on my legal issue. Can you also suggest steps I can take to find a licensed attorney who can provide me with legal advice in the Philippines?`;
        ...
        <div className="w-full max-w-xl px-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="align-items-center mt-10 flex items-center">
              ...
              <p className="ml-3 text-left text-base leading-normal text-slate-900 sm:text-lg lg:text-lg">
                <Balancer>Select a specific legal term.</Balancer>
              </p>
            </div>
            <div className="mt-3 block">
              <LegalTermDropDown
                legalTerm={legalTerm}
                setLegalTerm={(newLegalTerm) => setLegalTerm(newLegalTerm)}
              />
            </div>
            {!loading && (
              <button
                  ...
                  <div className="mx-auto flex max-w-xl flex-col items-center justify-center space-y-8 px-3">
                    ...
                    <div className="mt-2 rounded-lg bg-yellow-200 p-4 text-start text-base text-slate-900 sm:text-lg lg:text-lg">
                      ...
                      <p className="mb-4">
                        ...
                        user based on the legal advice generated by our AI
                        system.
                      </p>
                      <p className="mb-4">
